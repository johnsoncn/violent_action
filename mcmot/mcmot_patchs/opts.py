...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('task', default='mot', help='mot') #NC UPDATE - fallback to fairmot
        ...
        self.parser.add_argument('--batch_size',
                                 ...
                                 help='batch size') #NC UPDATE - fallback to fairmot
        ...
        #NC UPDATE
        from gen_mcmot_labels import id2cls
        id2cls_keys_s=",".join([str(k) for k in id2cls])
        self.parser.add_argument('--reid_cls_ids', default=id2cls_keys_s,help='NC default UPDATE')
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        #print("\n>>opt.reid_cls_ids: {} \n".format(opt.reid_cls_ids.split(',')))

        for reid_id in opt.reid_cls_ids.split(','):
            if int(reid_id) > opt.num_classes - 1:
                print()
                print('[Err]: configuration conflict of reid_cls_ids: {} and num_classes: {}'.format(int(reid_id), opt.num_classes - 1 ))
                return
