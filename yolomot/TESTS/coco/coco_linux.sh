...
"/home/administrator/Z/Algorithms/YOLOV4_MCMOT/train.py" \
 ...
 --batch="56" \
 --epochs="10" \
 --data="/home/administrator/Z/Algorithms/MOLA/NC/violent_action/yolomot/TESTS/coco/coco2017.data" \
 --cfg="/home/administrator/Z/Algorithms/MOLA/NC/violent_action/yolomot/TESTS/coco/yolov4-tiny.cfg" \
 --name="coco_test_1" \
 --device 0
