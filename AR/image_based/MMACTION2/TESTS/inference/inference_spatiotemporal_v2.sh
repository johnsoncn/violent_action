mkdir $PWD/"results"
for i in /home/administrator/Z/Work/EASYRIDE/P19/NC/SAMPLES/MOLA_2P_BACK_5V/*.avi;
...
--label-map /home/administrator/Z/Work/EASYRIDE/P19/NC/mmaction2/INFERENCES/I1/label_map_ava_violent.txt \
--predict-stepsize 4 \
--output-stepsize 4 \
--output-fps 6 \
